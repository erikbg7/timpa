...
<div class="bg-contrast grid grid-cols-2">
	<div class="flex min-h-screen flex-col items-center justify-center">
		<div class="flex w-[400px] flex-1 flex-col justify-center">
			<div class="mb-8 flex flex-col gap-2 text-sm">
				<h1 class="text-3xl font-semibold text-neutral-200">Sign in</h1>
				<p>
					New to {config.appName}?
					<a class="text-accent" href="/signin?mode=signup"> Sign up now </a>
				</p>
			</div>
			...
			<div class="text-center">
				<p class="text-sm">
					or <button class="text-accent">continue with email magic link</button>
				</p>
			</div>
		</div>
	...
	<div class="relative flex min-h-screen flex-col items-center justify-center overflow-hidden">
		...
		<svg
			viewBox="0 0 680 227"
			focusable="false"
			class="absolute -bottom-8 -left-20 w-[40rem] fill-none text-neutral-100"
			stroke-width="1"
			stroke-opacity="0.10"
			><path
				stroke="currentColor"
				d="M536.052 226.222c-46.866-80.226-101.644-132.314-224.565-64.572C194.322 226.222 22.481 165.563 1 140.126"
			></path><path
				stroke="currentColor"
				d="M616.115 222.308C569.249 142.083 451.416-7.332 311.487 99.035 198.227 185.131 22.48 110.775 1 85.338"
			></path><path
				stroke="currentColor"
				d="M678.602 222.308C631.736 142.083 497.348-80.858 311.486 32.507 176.747 114.689 20.527 52.074 1 32.507m454.989 191.758c-15.622-35.874-64.05-86.096-132.786 0"
			></path></svg
		>
	</div>
</div>
...
<style>
	.top-decoration {
		...
		width: 100%;
		height: 100%;
		background-image: linear-gradient(120deg, rgb(166, 192, 254) 0%, rgb(246, 128, 132) 100%);
		filter: blur(200px);
		opacity: 0.1;
